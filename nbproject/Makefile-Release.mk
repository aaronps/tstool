...
${OBJECTDIR}/_ext/2113088342/IMG_png.o: /D/prog/tstool/src/others/IMG_png.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -I/D/MinGW/include/SDL -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2113088342/IMG_png.o /D/prog/tstool/src/others/IMG_png.c

${OBJECTDIR}/_ext/2113088342/savepng.o: /D/prog/tstool/src/others/savepng.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/2113088342
	${RM} $@.d
	$(COMPILE.c) -O2 -I/D/MinGW/include/SDL -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2113088342/savepng.o /D/prog/tstool/src/others/savepng.c
